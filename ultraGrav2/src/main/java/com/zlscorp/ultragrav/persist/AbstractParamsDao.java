...
import com.zlscorp.ultragrav.model.AbstractParamsObject;
	...
	public void updateDefault(final T object, final TransactionCallback callback) {
		...
		try {
					...
					try {
						...
						if (callback != null) {
		                    ...
		                    errorHandler.logError(Level.SEVERE, this.getClass().getSimpleName() + 
		                            ".updateDefault(): Inner SQLException and callback is null - " + e, 
		                            0, 0); 
						}
					}
					return null;
			...
			if (callback != null) {
                ...
                ErrorHandler errorHandler = ErrorHandler.getInstance();
                errorHandler.logError(Level.SEVERE, this.getClass().getSimpleName() +
                        ".updateDefault(): Outer SQLException and callback is null - " + e, 
                        0, 0);
			}
		}
	}
